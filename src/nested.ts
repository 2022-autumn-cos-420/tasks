...
export function changeQuestionTypeById(
    ...
    const newArray: Question[] = questions.map((obj: Question) => ({
        ...
        options:
            obj.id == targetId && newQuestionType != "multiple_choice_question"
                ? []
                : [...obj.options]
    }));
    return newArray;
...
export function editOption(
    ...
    const newArray: Question[] = questions.map((obj: Question) => ({
        ...
        options:
            obj.id == targetId
                ? targetOptionIndex == -1
                    ? [...obj.options, newOption]
                    : obj.options.map((value: string, i: number) => {
...
export function duplicateQuestionInArray(
    ...
    let loc: number = -1;
    const newArray: Question[] = questions.map((obj: Question, i: number) => {
        if (obj.id == targetId) loc = i;
        return {
            ...obj,
            options: [...obj.options]
        };
    ...
    if (loc != -1)
        newArray.splice(loc + 1, 0, duplicateQuestion(newId, newArray[loc]));
    return newArray;
}
